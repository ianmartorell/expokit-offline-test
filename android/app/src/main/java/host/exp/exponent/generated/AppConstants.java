...
public class AppConstants {
  ...
  static {
    List<Constants.EmbeddedResponse> embeddedResponses = new ArrayList<>();
        ...
        embeddedResponses.add(new Constants.EmbeddedResponse("https://exp.host/@ianmartorell/offline-test", "assets://shell-app-manifest.json", "application/json"));
        embeddedResponses.add(new Constants.EmbeddedResponse("https://d1wp6m56sqw74a.cloudfront.net/%40ianmartorell%2Foffline-test%2F1.1.0%2F737d804433b48f50c1e87f144b949b35-30.0.0-android.js", "assets://shell-app.bundle", "application/javascript"));
